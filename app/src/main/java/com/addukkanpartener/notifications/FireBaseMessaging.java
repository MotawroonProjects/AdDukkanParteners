package com.addukkanpartener.notifications;
...
public class FireBaseMessaging extends FirebaseMessagingService {
    ...
    public void onMessageReceived(@NonNull RemoteMessage remoteMessage) {
        ...
        if (notification_type.equals("chat")) {
            ...
            if (className.equals("com.addukkanpartener.uis.activity_chat.ChatActivity")) {
                ...
                if (room_id.equals(current_room_id)){
                    ...
                    UserModel.User from_user = new Gson().fromJson(from,UserModel.User.class);
                    UserModel.User to_user = new Gson().fromJson(to,UserModel.User.class);
