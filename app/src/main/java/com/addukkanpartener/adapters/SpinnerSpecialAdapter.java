...
public class SpinnerSpecialAdapter extends BaseAdapter {
    private List<SpecialModel> list;
    private Context context;
    private LayoutInflater inflater;

    public SpinnerSpecialAdapter(List<SpecialModel> list, Context context) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String title = list.get(position).getSpecialization_trans_fk().getTitle();
